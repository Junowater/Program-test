...
// Function to reload workstations and regenerate UI
function reloadWorkstations() {
    generateSkillsTable(); // Update the skills table
    generateScheduleTable(); // Update the schedule table if needed
}
...
// Event listeners for adding and removing workstations
document.getElementById('addWorkstationBtn').addEventListener('click', function () {
    const workstationName = document.getElementById('newWorkstationName').value.trim();
    if (workstationName) {
        addWorkstation(workstationName);
